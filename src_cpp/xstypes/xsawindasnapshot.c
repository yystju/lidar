...
*/
void XsAwindaSnapshot_construct(XsAwindaSnapshot* thisPtr)
{
	memset(thisPtr, 0, sizeof(XsAwindaSnapshot));
}

/*!	\relates XsAwindaSnapshot
	\brief Destruct an %XsAwindaSnapshot object
*/
void XsAwindaSnapshot_destruct(XsAwindaSnapshot* thisPtr)
{
	(void) thisPtr;
}
