...
uint32_t XsDeviceId_deviceType(struct XsDeviceId const* thisPtr)
{
	uint32_t deviceMask = XsDeviceId_deviceTypeMask(thisPtr);
...
uint32_t XsDeviceId_deviceTypeMask(struct XsDeviceId const* thisPtr)
{
	uint32_t deviceMask;

	if (XsDeviceId_isMtMk4_X(thisPtr) || XsDeviceId_isFmt_X000(thisPtr))
		deviceMask = (XS_DID_GPH_MASK | XS_DID_GPL_MASK | XS_DID_TYPEH_MASK | XS_DID_TYPEL_MASK);
	else if (XsDeviceId_isMtMk4(thisPtr))
		deviceMask = (XS_DID_GPH_MASK | XS_DID_GPL_MASK | XS_DID_TYPEH_MASK);
		...
		deviceMask = (XS_DID_GPH_MASK | XS_DID_GPL_MASK | XS_DID_TYPE_MASK);
