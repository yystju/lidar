...
XSTYPES_DLL_API void XsDataPacket_setAwindaSnapshot(XsDataPacket* thisPtr, XsAwindaSnapshot const * data, int retransmission);
XSTYPES_DLL_API XsAwindaSnapshot* XsDataPacket_awindaSnapshot(XsDataPacket const * thisPtr, XsAwindaSnapshot* returnVal);
...
struct XsDataPacket {
	...
	*/
	...
	XSNOEXPORT inline XsAwindaSnapshot awindaSnapshot(void) const
	{
		XsAwindaSnapshot returnVal;
	...
	XSNOEXPORT inline void setAwindaSnapshot(XsAwindaSnapshot const& raw, bool retransmission)
	{
